...
#-----------------                
            ...
            tr_out.write("healpix_%d.fits" % int(pix),format="fits",overwrite=True)
            #tr_out.write("../../../../mnt/lustrefs/scratch/katie.fasbender/nsc_fast_track_healpix/healpix_%d.fits" % int(pix),format="fits",overwrite=True)
